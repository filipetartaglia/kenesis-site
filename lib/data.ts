...
export const equipe = [
  { name: "Filipe Moura", role: "CEO da Kenesis", location: "Niterói, Rio de Janeiro" },
  { name: "Filipe Tartaglia", role: "CEO e CTO da Kenesis · Corretor", location: "Niterói, Rio de Janeiro" },
  { name: "Vinicius Rodrigues", role: "Atendente Kenesis", location: "Niterói, Rio de Janeiro" },
];
